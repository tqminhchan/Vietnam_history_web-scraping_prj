...
public class XCell_DiaDiem extends XCell {
    public XCell_DiaDiem(){
        super();
        button.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                for (DiaDiem diaDiem : listDiaDiem) {
                    if (diaDiem.getTen().equals(lastItem)) {
                        diaDiemInfo = diaDiem;
                        break;
                    } else {
                        diaDiemInfo.setTen(lastItem);
                    }
                }
                ...
                newWindow.setTitle("Location Info");
